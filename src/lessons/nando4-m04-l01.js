export default {
    ...
    timeline: {
        ...
        stepB: {
            ...
            cards: [
                ...
                { id: 'card-activity', type: 'digital', title: 'Interactieve Verwerking', description: 'Verken visueel.', action: 'activity', activityId: 'mixedRetrieval', icon: 'PhGameController' }
            ]
        },
        stepC: {
    ...
    activities: {
        'mixedRetrieval': {
            type: 'mixedRetrieval',
            title: 'Herhaling M1-M3'
            
        }
    },
    slidesA: [
        { layout: 'title', title: 'Nando 4 Module 04', subtitle: 'Deel 1', badge: 'Wiskunde', icon: 'function' },
        { layout: 'standard', title: 'Consolidatie', content: '[Afbeelding: Achtergrondafbeelding met een digitaal/ruimte-thema en de tekst \"CORRECTIESLEUTEL\" diagonaal in het rood eroverheen gestempeld.]<br>**Inhoud (elk onderdeel behandelt de leerstof van module 01 t.e.m. 03)**<br>| | |<br>|---|---|<br>| blz. 02 – 03 | Ken je de theorie? |<br>| blz. 04 – 05 | Oefeningenreeks 1 peper |<br>| blz. 06 | Problemen oplossen met heuristieken |<br>| blz. 07 – 10 | Oefeningenreeks 2 pepers |<br>| blz. 11 – 18 | Oefeningenreeks 3 pepers |<br>| blz. 19 | Problemen oplossen met heuristieken |<br>| blz. 20 – 21 | Oefeningenreeks 4 pepers |<br>| blz. 22 – 27 | Oefeningenreeks 5 pepers |<br>| blz. 28 | Problemen oplossen met heuristieken |<br>| blz. 29 – 30 | Wiskunde in taal |<br>| blz. 32 | Overzicht oefenmateriaal |<br>**IN DEZE CONSOLIDATIEMODULE VIND JE THEORIEVRAGEN EN HERHALINGSVRAGEN IN VERSCHILLENDE PEPERCATEGORIEËN OVER VOLGENDE MODULES:**<br>– Module 1: Logica en waarheidstabellen<br>– Module 2: Stelsels van eerstegraadsvergelijkingen<br>– Module ', icon: 'book-open' }
    ],
    slidesB: [
