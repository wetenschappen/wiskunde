export default {
    ...
    slidesA: [
        { layout: 'title', title: 'Nando 3 Module 16', subtitle: 'Deel 1', badge: 'Wiskunde', icon: 'function' },
        { layout: 'standard', title: 'Data en onzekerheid', content: 'D-FINALITEIT 5 UUR – DATA EN ONZEKERHEID<br>## WAT JE AL KUNT<br>– informatie uit tabellen, grafieken en diagrammen halen<br>– soorten data (numeriek of categorisch) onderscheiden<br>– met behulp van ICT van gegevens een absolute frequentietabel, dotplot, staafdiagram, lijndiagram en cirkeldiagram voorstellen<br>– het bepalen en interpreteren van rekenkundig gemiddelde, mediaan, modus en variatiebreedte van een reeks gegevens<br>## WAT JE LEERT IN DEZE MODULE<br>– met ICT niet-gegroepeerde en gegroepeerde gegevens voorstellen aan de hand van passende voorstellingswijzen: absolute en relatieve frequentietabel, staafdiagram, dotplot, cirkeldiagram, lijndiagram, histogram en boxplot<br>– met ICT centrum- en spreidingsmaten bepalen: rekenkundig gemiddelde, mediaan, modus, variatiebreedte, kwartielen, interkwartielafstand en standaardafwijking<br>– voorstellingswijzen, centrum- en spreidingsmaten analyseren en interpreteren bij een statistisch onderzoek van één grootheid<br>– centrummaten, ', icon: 'book-open' }
    ],
    slidesB: [
