export default {
    ...
    timeline: {
        ...
        stepB: {
            ...
            cards: [
                ...
                { id: 'card-activity', type: 'digital', title: 'Interactieve Verwerking', description: 'Verken visueel.', action: 'activity', activityId: 'similarity', icon: 'PhBoundingBox' }
            ]
        },
        stepC: {
    ...
    activities: {
        'similarity': {
            type: 'similarity',
            title: 'Gelijkvormigheid'
            
        }
    },
    slidesA: [
        { layout: 'title', title: 'Nando 3 Module 07', subtitle: 'Deel 3', badge: 'Wiskunde', icon: 'function' },
