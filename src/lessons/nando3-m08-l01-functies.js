export default {
    ...
    slidesA: [
        { layout: 'title', title: 'Nando 3 Module 08', subtitle: 'Deel 1', badge: 'Wiskunde', icon: 'function' },
        { layout: 'standard', title: 'Instap', content: '## Opdracht 1<br>Een vliegtuig vliegt met een constante snelheid van 1000 km/h.<br>a) Vul onderstaande tabel aan.<br>| tijd t (in minuten) | 30 | 60 | 90 | 120 | 150 | 180 | 210 |<br>| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |<br>| **afgelegde weg s (in km)** | 500 | 1000 | 1500 | 2000 | 2500 | 3000 | 3500 |<br>b) Plaats de gegevens uit de tabel in een grafiek. (De tijd is de horizontale as en de afgelegde weg is de verticale as.)<br>[Afbeelding: Grafiek met x-as \'t (min)\' van 0 ...', icon: 'rocket' }
    ],
    slidesB: [
        { layout: 'standard', title: 'Algebraïsche verbanden en ongelijkheden', content: '[Afbeelding: Grote rode stempel met de tekst \"CORRECTIESLEUTEL\" schuin over de pagina, over een achtergrondfoto van skiërs op een besneeuwde helling.]<br>**Inhoud**<br>**Instap**<br>**1 Het verband tussen 2 grootheden weergeven**<br>**2 Reële functies**<br>**3 Ongelijkheden**<br>**4 Problemen oplossen**<br>**Signaaloefeningen**<br>**Differentiatietraject**<br>**Studiewijzer**<br>### WAT JE AL KUNT<br>– de eigenschappen van gelijkheden toepassen<br>– vergelijkingen algebraïsch toepassen in r<br>– formules omvormen naar één onbekende<br>– vergelijkingen met één parameter oplossen en bespreken<br>– de coördinaat van een punt aflezen in een cartesiaans assenstelsel<br>– informatie aflezen uit tabellen van eenvoudige verbanden<br>– de grafiek tekenen van recht evenredige grootheden<br>– een formule opstellen bij het vaststellen van een patroon of regelmaat<br>### WAT JE LEERT IN DEZE MODULE<br>– het verband tussen twee veranderlijke grootheden door middel van een tabel, grafiek of formule', icon: 'book-open' },
        { layout: 'standard', title: 'Het verband tussen 2 grootheden weergeven', content: '## 1.1 In een tabel<br>Als je een bergwandeling maakt, merk je dat hoe hoger je gaat, hoe kouder het wordt. In de tabel vind je de buitentemperatuur bij een welbepaalde hoogte.<br>| HOOGTE (in m) | TEMPERATUUR (in °C) |<br>| :---: | :---: |<br>| 1000 | 8,5 |<br>| 1600 | 4,6 |<br>| 2400 | −0,6 |<br>| 3400 | −7,1 |<br>| 4600 | −14,9 |<br>| 6000 | −24,0 |<br>[Afbeelding: Foto van een wandelaar in een besneeuwd berglandschap.]<br>In de tabel lezen we twee **grootheden** af. De hoogte in meter en de temperatuur in graden Celsius. Uit de tabel kun je afleiden dat de buitentemperatuur **8,5 °C** bedraagt op een hoogte van **1000 m**.<br>**Voor- en nadelen van het voorstellen van grootheden in een tabel:**<br>• Het is overzichtelijk, maar een verband afleiden is moeilijk.<br>• Gegeven waarden kunnen exact afgelezen worden.<br>• Er zijn maar een beperkt aantal waarden gegeven.<br>• We moeten kritisch zijn bij het veralgemenen en het berekenen van tussenliggende of verderliggende waarden.<br>We ', icon: 'book-open' },
        { layout: 'standard', title: 'Reële functies', content: 'Bij sommige verbanden bestaat er voor elke invoerwaarde maximaal één uitvoerwaarde. Deze bijzondere verbanden noemen we functies.<br>## 2.1 Wat is een functie?<br>**Voorbeeld: Er is een verband tussen de lengte van een zijde van een vierkant en de omtrek van dat vierkant.**<br>**De invoer:** de waarden die je zelf kiest. We noemen dit de **onafhankelijke veranderlijke**.<br>Op de grafiek vind je die op de horizontale as, de x-as.<br>| LENGTE ZIJDE VIERKANT (in cm) | 0,0 | 0,2 | 1,0 | 1,7 | 2,0 |<br>| :--- | :--- | :--- | :--- | :--- | :--- |<br>| **OMTREK VIERKANT (in cm)** | 0,0 | 0,8 | 4,0 | 6,8 | 8,0 |<br>**De uitvoer:** de waarden die je berekent. We noemen dit de **afhankelijke veranderlijke**.<br>Op de grafiek vind je die op de verticale as, de y-as.<br>[Afbeelding: Illustratie van een machine met \'FORMULE\' erop. Ballen met getallen 1, 2, 4 gaan erin (invoer), ballen met 4, 8, 16 komen eruit (uitvoer). Ernaast een schematische voorstelling met pijlen van INVOER (0, 0.2, 1, 1.7,', icon: 'book-open' },
        { layout: 'standard', title: 'Ongelijkheden', content: '## 3.1 Wat is een ongelijkheid?<br>**Voorbeelden**<br>x < 5<br>6 + x ⩾ 2x − 3<br>Voor deze uitspraken die we **ongelijkheden** noemen, kunnen we op zoek gaan naar mogelijkheden voor de onbekende x.<br>**Voorbeeld**<br>Om de eindejaarsreis van de zesdejaars te sponsoren, verkopen de leerlingen chocoladedoosjes voor 7 euro per stuk. De kost voor één doosje is 4 euro en voor het verpakkingsmateriaal en de marketing is er een éénmalige kost van 180 euro.<br>We kunnen het verband tussen de winst of verlies weergeven in functie van het aantal chocoladedoosjes op de volgende grafiek.<br>[Afbeelding: Doosje pralines met roze lint.]<br>[Afbeelding: Grafiek. x-as: \'aantal doosjes\' van -500 tot 600. y-as: \'winst of verlies (in euro)\' van -300 tot 400. Een stijgende rechte lijn (rode en groene kleur) snijdt de y-as bij -180 en de x-as bij 60. Het deel onder de x-as is rood, het deel boven de x-as is groen.]<br>• Hoeveel doosjes moeten ze verkopen om geen winst of verlies te hebben?<br>Wanneer ', icon: 'book-open' }
    ],
    slidesC: [
