export default {
    ...
    activities: {
        'mixedRetrieval': {
            type: 'mixedRetrieval',
            title: 'Herhaling M1-M13'
            
        }
    },
    slidesA: [
        { layout: 'title', title: 'Nando 4 Module 14', subtitle: 'Deel 1', badge: 'Wiskunde', icon: 'function' },
