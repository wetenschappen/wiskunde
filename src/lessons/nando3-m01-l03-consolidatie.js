export default {
    ...
    timeline: {
        ...
        stepB: {
            ...
            cards: [
                ...
                { id: 'card-activity', type: 'digital', title: 'Interactieve Verwerking', description: 'Verken visueel.', action: 'activity', activityId: 'logic', icon: 'PhTreeStructure' }
            ]
        },
        stepC: {
    ...
    slidesA: [
        { layout: 'title', title: 'Nando 3 Module 01', subtitle: 'Deel 3', badge: 'Wiskunde', icon: 'function' },
