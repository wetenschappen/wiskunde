export default {
    ...
    timeline: {
        ...
        stepB: {
            ...
            cards: [
                ...
                { id: 'card-activity', type: 'digital', title: 'Interactieve Verwerking', description: 'Verken visueel.', action: 'activity', activityId: 'pythagoras', icon: 'PhTriangle' }
            ]
        },
        stepC: {
    ...
    slidesA: [
        { layout: 'title', title: 'Nando 3 Module 11', subtitle: 'Deel 2', badge: 'Wiskunde', icon: 'function' },
