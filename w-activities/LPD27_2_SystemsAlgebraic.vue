...
function onDrop() {
  if (draggedItem === currentLevelData.value.dragTarget) {
    ...
    feedback.value = { type: 'error', text: 'Niet helemaal... Je sleept het verkeerde stuk. Sleep het expressiegedeelte (rechts) naar de variabele in de andere vergelijking.' }
    draggedItem = null
  }
}
...
function checkAnswer() {
  ...
  if (!substituted.value) {
    isCorrect.value = false;
    feedback.value = { type: 'error', text: 'Niet helemaal... Je moet eerst de substitutie uitvoeren door te slepen.' }
    return;
  }
        ...
        <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 shadow-inner-light md:flex z-10">
          ...
          <div class="p-6 bg-slate-50 border-t border-slate-200 shrink-0">
            ...
            <div class="flex items-center gap-4">
              ...
              <button v-if="!isCorrect" @click="checkAnswer" :disabled="isChecked && !isCorrect || !substituted || !answeredVar" class="flex-1 py-4 font-bold text-white transition-all rounded-lg shadow-md bg-slate-800 hover:bg-slate-900 disabled:opacity-50 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-math-blue focus-visible:outline-none">
                Controleer
              </button>
