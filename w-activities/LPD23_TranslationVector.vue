    ...
    if (dist < 15) {
        ...
        if (dist > 50) {
            if (attemptCount.value >= 3) {
              feedback.value = { type: 'error', text: 'Niet helemaal... Blijf de pijlpunt verslepen tot de vorm exact op de stippellijn ligt.' }
            } else {
              feedback.value = { type: 'error', text: 'Niet helemaal... Je bent er nog niet. Sleep de punt van de pijl verder zodat de blauwe vorm EXACT op de stippellijn past.' }
            }
        }
    }
}
