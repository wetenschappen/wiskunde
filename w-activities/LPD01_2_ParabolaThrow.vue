    ...
    const interval = setInterval(() => {
        ...
        if (target.hasDefender) {
            if (x > target.defenderX - 0.5 && x < target.defenderX + 0.5 && ballY.value < target.defenderY) {
                ...
                feedback.value = { type: 'error', text: 'Niet helemaal... Geblokt! De bal is tegen de verdediger gekomen. ' + hints[hintIdx] }
                setTimeout(() => {
        ...
        <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 shadow-inner-light md:flex z-10">
          ...
          <div class="p-6 bg-slate-50 border-t border-slate-200 shrink-0">
            ...
            <div class="flex items-center gap-4">
              ...
              <button v-if="!isCorrect" @click="shootBall" :disabled="isShooting" class="flex-1 py-4 font-bold text-white transition-all rounded-lg shadow-md bg-math-blue hover:bg-math-blue active:scale-[0.98] flex items-center justify-center gap-2 focus-visible:ring-2 focus-visible:ring-math-blue focus-visible:outline-none">
