        ...
        <div class="flex flex-col flex-1 overflow-hidden bg-slate-900">
          <div class="flex flex-col flex-1 p-6 overflow-y-auto items-center justify-center relative bg-circuit-pattern">
            <div class="w-full max-w-4xl flex flex-col items-center gap-8">
              ...
              <!-- Reverse Pipeline -->
              <div class="flex items-center w-full justify-between px-8 bg-slate-800 p-6 rounded-xl border-4 border-slate-600 shadow-md relative">
                <div class="w-24 h-24 rounded-xl flex items-center justify-center shadow-inner transition-colors" :class="isCorrect ? 'bg-emerald-500 border-4 border-emerald-300' : 'bg-slate-900 border-4 border-emerald-600'">
                ...
                <div class="w-24 h-24 rounded-xl flex items-center justify-center shadow-inner transition-colors" :class="step >= 2 ? 'bg-emerald-800 border-4 border-emerald-500' : 'bg-slate-900 border-4 border-slate-600'">
                ...
                <div class="w-24 h-24 rounded-xl bg-slate-700 border-4 border-slate-500 flex items-center justify-center shadow-inner"><span class="font-black text-4xl text-white">{{ currentLevel.final }}</span></div>
              </div>
            </div>
          </div>
        </div>
