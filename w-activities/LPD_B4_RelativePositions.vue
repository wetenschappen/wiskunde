...
function selectOption(opt) {
  ...
  if (opt === currentScenario.value.correct) {
    ...
    feedback.value = {
      type: 'error',
      text: 'Niet helemaal... Niet juist. ' + getHint()
    }
  }
}
            ...
            <div class="p-6 mt-6 border-t border-slate-200 bg-slate-50 rounded-xl">
              ...
              <div class="flex flex-col gap-4">
                <button v-for="opt in options" :key="opt"
                        ...
                        class="p-4 border-2 rounded-xl text-left font-bold transition-all capitalize active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-math-blue focus-visible:outline-none"
                        :class="{
