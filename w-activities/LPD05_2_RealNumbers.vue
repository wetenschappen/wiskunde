        ...
        <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 shadow-inner-light md:flex z-10">
          <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="mt-6 flex flex-col gap-2">
                <button @click="checkTriangle" v-if="step === 0" class="py-4 px-4 bg-math-blue text-white font-bold rounded-lg shadow-sm hover:bg-math-blue active:scale-95 transition-all focus-visible:ring-2 focus-visible:ring-math-blue focus-visible:outline-none">
                    1. Valideer Driehoek
                </button>
                <button @click="dropToAxis" v-if="step === 1" class="py-4 px-4 bg-emerald-500 text-white font-bold rounded-lg shadow-sm hover:bg-emerald-400 active:scale-95 transition-all flex items-center justify-center gap-2 animate-pulse focus-visible:ring-2 focus-visible:ring-math-blue focus-visible:outline-none">
