...
const levels = [
  {
    goalText: 'Opdracht 1: Vereenvoudig √18.',
    targetRoot: 18,
    perfectSquare: 9,
    remainder: 2,
    finalAns: '3√2',
  ...
  {
    goalText: 'Opdracht 2: Vereenvoudig √50.',
    targetRoot: 50,
    perfectSquare: 25,
    remainder: 2,
    finalAns: '5√2',
  ...
  {
    goalText: 'Opdracht 3: Vereenvoudig √75.',
    targetRoot: 75,
    perfectSquare: 25,
    remainder: 3,
    finalAns: '5√3',
...
function checkAnswer() {
  ...
  if (inputSquare.value * inputRemainder.value !== target.targetRoot) {
    isCorrect.value = false;
    feedback.value = { type: 'error', text: `Foutje: ${inputSquare.value} × ${inputRemainder.value} is geen ${target.targetRoot}!` };
    return;
  }
  ...
  // What if they swapped them?
    ...
    // Math is right, but not the *largest* perfect square (e.g. 2 x 9 instead of 9 x 2 or didn't pick square)
    const isSquare = Math.sqrt(inputSquare.value) % 1 === 0;
    if (!isSquare) {
      feedback.value = { type: 'error', text: `${inputSquare.value} is géén perfect kwadraat! Je kunt er niet mooi de wortel uit trekken. Probeer getallen als 4, 9, 16, 25...` };
    } else {
          ...
          <div class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="p-6 border border-slate-200 bg-slate-50 rounded-xl space-y-4 shadow-inner">
              ...
              <div class="flex items-center justify-between gap-2">
                 ...
                 <div class="text-slate-400 font-black text-xl mt-4">×</div>
                 <div class="flex-1">
