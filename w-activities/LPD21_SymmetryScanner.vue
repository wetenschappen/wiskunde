...
import {
  PhX, PhCheckCircle, PhWarningCircle, PhArrowRight, PhArrowsLeftRight, PhArrowClockwise, PhArrowsClockwise, PhSplitHorizontal
...
function checkAnswer() {
  ...
  if (userAns.value === target) {
    if (testState.value === 'none') {
        isCorrect.value = false
        attemptCount.value++
        feedback.value = { type: 'error', text: 'Niet helemaal... Het antwoord is correct, maar gebruik de scanner knoppen eerst om het met je eigen ogen te bewijzen! ' + hint }
    } else {
    ...
    if (userAns.value === 'line') {
        ...
        feedback.value = { type: 'error', text: 'Niet helemaal... Kies een antwoord uit de lijst. ' + hint }
    }
  }
}
          ...
          <div class="flex flex-col flex-1 p-6 overflow-y-auto items-center justify-center relative pattern-grid">
              ...
              <div class="w-full max-w-4xl flex flex-col items-center">
                  ...
                  <div class="flex gap-4 mb-12">
                      <button @click="runTest('line')" :disabled="isCorrect" class="px-6 py-4 font-bold bg-white text-math-blue border-2 border-math-blue rounded-xl shadow-md flex items-center gap-2 hover:bg-math-blue-bg active:scale-95 transition-all focus-visible:ring-2 focus-visible:ring-math-blue focus-visible:outline-none">
                          <PhSplitHorizontal weight="bold" class="w-6 h-6" /> Test Lijnsymmetrie
                      </button>
                      <button @click="runTest('point')" :disabled="isCorrect" class="px-6 py-4 font-bold bg-white text-math-blue border-2 border-math-blue rounded-xl shadow-md flex items-center gap-2 hover:bg-math-blue-bg active:scale-95 transition-all focus-visible:ring-2 focus-visible:ring-math-blue focus-visible:outline-none">
