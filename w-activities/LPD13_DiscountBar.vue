        ...
        <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 shadow-inner-light md:flex z-10">
          <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="p-4 mt-6 border border-surface-200 bg-math-blue-bg rounded-xl shadow-inner">
               <label class="block text-sm font-bold text-math-blue mb-2">Nieuwe Prijs:</label>
               <div class="flex items-center gap-2">
                   ...
                   <input type="number" v-model.number="userAns" placeholder="..." :disabled="isCorrect"
                          class="w-full font-bold text-2xl p-4 border border-surface-200 rounded-lg focus:border-math-blue focus:ring-math-blue bg-white" />
               </div>
            </div>
          </div>
          ...
          <div class="flex flex-col flex-1 p-6 overflow-y-auto items-center justify-center relative pattern-grid">
              ...
              <div class="w-full max-w-4xl relative">
                  ...
                  <div v-if="discountApplied" class="absolute -bottom-16 left-0 flex flex-col items-center animate-fadeIn"
                      ...
                      <div class="w-full h-4 border-b-2 border-x-2 border-math-blue rounded-b-lg mt-1 relative">
                          <span class="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-slate-50 px-2 font-black text-lg text-math-blue whitespace-nowrap">{{ remainingBlocks * 10 }}% = Nieuwe Prijs</span>
                      </div>
                  </div>
                  ...
                  <button v-if="!discountApplied" @click="applyDiscount"
                          class="absolute -bottom-16 bg-white border-2 border-red-500 text-red-600 font-bold px-4 py-2 rounded-full shadow-md flex items-center gap-2 hover:bg-red-50 hover:scale-105 active:scale-95 transition-all focus-visible:ring-2 focus-visible:ring-math-blue focus-visible:outline-none"
