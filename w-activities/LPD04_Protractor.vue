...
const levels = [
  { goalText: 'Opdracht 1: Teken een scherpe hoek van exact 50°.', targetAngle: 50, hint: 'Een scherpe hoek is kleiner dan 90°.' },
  { goalText: 'Opdracht 2: Teken een stompe hoek van 130°.', targetAngle: 130, hint: 'Een stompe hoek is groter dan 90°.' },
  { goalText: 'Opdracht 3: Teken een zeer scherpe hoek van 15°.', targetAngle: 15, hint: 'Kijk naar de kleine streepjes tussen de tientallen.' }
]
...
function checkAnswer() {
  ...
  if (userAngle.value === currentLevelData.value.targetAngle) {
    isCorrect.value = true
    feedback.value = { 
      type: 'success', 
      text: 'Uitstekend! Je hebt de geodriehoek correct afgelezen en de hoek perfect getekend.' 
    }
  } else if (userAngle.value === 180 - currentLevelData.value.targetAngle) {
    isCorrect.value = false
    feedback.value = { type: 'error', text: `Let op de schaal! Je leest de verkeerde boog af. Je hebt nu een hoek van ${userAngle.value}° getekend.`}
  } else {
    isCorrect.value = false
    feedback.value = { type: 'error', text: `Je huidige hoek is ${userAngle.value}°. ${currentLevelData.value.hint}`}
  }
}
