...
// The Graph
// A is connected to B, C, D (degree 3)
const correctDegree = 3
...
function checkAnswer() {
  ...
  if (parseInt(userAnswer.value) === correctDegree) {
    ...
    feedback.value = { 
      type: 'success', 
      text: 'Helemaal juist! De graad van knoop A is 3, want er vertrekken 3 bogen.' 
    }
  } else {
    isCorrect.value = false
    feedback.value = { 
      type: 'error', 
      text: 'Niet juist. Tel hoeveel lijnen (bogen) er rechtstreeks aan knoop A vastzitten.'
    }
  }
}
        ...
        <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 shadow-inner-light md:flex z-10">
          <div class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="p-6 mt-6 border-t border-slate-200 bg-slate-50 rounded-xl space-y-4">
              <label class="block mb-2 text-sm font-bold text-slate-700">Wat is de graad van A?</label>
