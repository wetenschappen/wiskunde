  ...
  if (userAns.value === data.exactAns) {
    if (cutPosition.value === data.bestCut) {
        ...
        if (attemptCount.value === 1) {
          feedback.value = { type: 'error', text: 'Niet helemaal... Het antwoord is juist, maar je hebt de snijlijn niet gebruikt om het jezelf makkelijk te maken! Verplaats de slider.'}
    ...
    if (cutPosition.value > 0 && cutPosition.value < data.totalWidth) {
        if (attemptCount.value === 1) {
          feedback.value = { type: 'error', text: `Niet helemaal... Rekenfout. Kijk naar je eigen snijlijn. Wat is ${calculationResult.value.split('=')[0]}?`}
        } else if (attemptCount.value === 2) {
        ...
        if (attemptCount.value === 1) {
          feedback.value = { type: 'error', text: `Niet helemaal... Fout antwoord. Gebruik de schaar om de berekening te splitsen!` }
        } else if (attemptCount.value === 2) {
