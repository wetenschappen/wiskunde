          ...
          <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="p-4 mt-6 border border-orange-200 bg-orange-50 rounded-xl shadow-inner">
               ...
               <div class="flex flex-col gap-2">
                   <div class="font-mono text-xs md:text-sm text-slate-600 bg-white p-2 rounded border border-slate-300 overflow-hidden text-ellipsis whitespace-nowrap" :title="calculationString">
                       {{ calculationString }}
                   </div>
                   <div class="font-mono font-bold text-orange-600 bg-orange-100 p-2 rounded border border-orange-300">
                       {{ calculationResult }}
                   </div>
                   <div class="flex items-center gap-2 mt-2">
                       <span class="font-bold">Eindantwoord:</span>
                       <input type="number" v-model.number="userAns" placeholder="..." :disabled="isCorrect"
                              class="w-full font-bold text-lg p-2 border-2 border-orange-400 rounded focus:border-orange-500 focus:ring-orange-500 text-center" />
                   </div>
               </div>
            </div>
          </div>
