...
// Data: Mon: 10, Tue: 12, Wed: 15, Thu: 15, Fri: 11
const points = [
    { day: 'Ma', temp: 10 },
    { day: 'Di', temp: 12 },
    { day: 'Wo', temp: 15 },
...
function checkAnswer(ans) {
  ...
  if (ans === false) {
    ...
    feedback.value = { 
      type: 'success', 
      text: 'Goed gezien! Het werd inderdaad warmer van Ma naar Wo, maar op Donderdag bleef de temperatuur GELIJK (horizontale lijn) aan Woensdag. Pas op Vrijdag daalde het.' 
    }
  } else {
    isCorrect.value = false
    feedback.value = { type: 'error', text: 'Fout! Kijk heel goed naar het lijnstukje tussen Woensdag en Donderdag. Gaat dat echt omlaag? Of blijft het horizontaal?'}
  }
}
        ...
        <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 shadow-inner-light md:flex z-10">
          <div class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="p-4 mt-6 border border-slate-200 bg-slate-50 rounded-xl shadow-inner">
               <label class="block text-sm font-bold text-slate-700 mb-3">Uitspraak: "Elke dag warmer, tot het op donderdag daalde."</label>
        ...
        <div class="flex flex-col flex-1 overflow-hidden bg-slate-50">
          <div class="flex flex-col flex-1 p-6 overflow-y-auto items-center justify-center relative pattern-grid">
              ...
              <div class="w-full max-w-2xl bg-white shadow-xl rounded-3xl border-4 border-slate-300 p-8 flex flex-col items-center">
                  ...
                  <h4 class="font-bold text-slate-500 uppercase tracking-widest text-xs mb-6">Temperatuur (°C)</h4>
                  ...
                  <div class="relative">
                      <svg width="500" height="300" viewBox="0 0 500 300" class="block">
                          ...
                          <g v-for="(pt, idx) in points" :key="'pt'+idx">
                              ...
                              <!-- Tooltips on hover (for extra interactivity) -->
                          ...
                          <circle v-if="isChecked && !isCorrect" cx="290" cy="100" r="40" fill="none" stroke="#f43f5e" stroke-width="3" stroke-dasharray="4 4" class="animate-pulse" />
