...
function transformShape() {
    ...
    step.value = 1
    feedback.value = { type: 'success', text: 'Kijk! Een parallellogram kan je verknippen tot een perfecte RECHTHOEK. De basis en de hoogte blijven exact hetzelfde.' }
}
        ...
        <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 shadow-inner-light md:flex z-10">
            ...
            <div class="p-4 mt-6 border border-orange-200 bg-orange-50 rounded-xl shadow-inner text-center">
               ...
               <div class="flex items-center gap-2">
                   <input type="number" v-model.number="userAns" placeholder="..." :disabled="isCorrect"
                          class="w-full font-bold text-xl p-3 border-2 border-orange-300 rounded-lg focus:border-orange-500 focus:ring-orange-500 text-center" />
          ...
          <div class="p-6 bg-slate-50 border-t border-slate-200 shrink-0">
            ...
            <div class="flex items-center gap-3">
              ...
              <button v-if="!isCorrect" @click="checkAnswer" :disabled="isChecked && !isCorrect && userAns === null" class="flex-1 py-3 font-bold text-white transition-all rounded-lg shadow-md bg-slate-800 hover:bg-slate-900 disabled:opacity-50 active:scale-[0.98]">Controleer Oppervlakte</button>
