            ...
            <div class="p-4 mt-6 border border-surface-200 bg-math-blue-bg rounded-xl shadow-inner">
               ...
               <div class="flex items-center gap-2">
                   <input type="number" v-model.number="userAns" placeholder="..." :disabled="isCorrect"
                          class="flex-1 font-bold text-xl p-4 border-2 border-math-blue rounded-lg focus:border-math-blue focus:ring-math-blue text-center bg-white" />
              ...
              <div class="w-full max-w-2xl flex flex-col items-center">
                  ...
                  <div class="mb-12 w-full max-w-sm bg-white p-6 rounded-xl shadow-sm border border-slate-200 z-10">
                      <div class="flex justify-between items-end mb-4">
                          ...
                          <span class="font-black text-2xl" :class="isOverlapping ? 'text-emerald-600' : 'text-math-blue'">{{ rotation }}°</span>
                      </div>
