...
watch([valA, valP, valQ], () => {
  ...
  if (valA.value === t.a && valP.value === t.p && valQ.value === t.q) {
    ...
    feedback.value = {
      type: 'success',
      text: `Prima! Briljant! De parabool dekt het doelwit perfect af. f(x) = ${t.a === 1 ? '' : (t.a === -1 ? '-' : t.a)}(x ${t.p >= 0 ? '- ' + t.p : '+ ' + Math.abs(t.p)})² ${t.q >= 0 ? '+ ' + t.q : '- ' + Math.abs(t.q)}`
    }
        ...
        <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 shadow-inner-light md:flex z-10">
          <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="p-6 mt-6 border-t border-slate-200 bg-slate-50 rounded-xl space-y-6">
              ...
              <div class="text-center bg-white p-4 border border-slate-200 rounded-lg shadow-sm">
